    ...
    <div class="container">
        ...
        <div class="row align-items-center justify-content-center gx-lg-5">
            ...
            <div class="col-lg-4 text-center mb-5 mb-lg-0">
                <div class="big-profile-icon-wrapper-square">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" class="big-profile-svg-curved">
                        ...
                        <path d="M 2 15 C 2 8, 14 8, 14 15" fill="none" stroke="currentColor" stroke-width="1.5"
            ...
            <div class="col-lg-6">
                ...
                <div class="mb-4">
                    <h2 class="fw-bold" style="color: #0B132A;">
                        HALO <span class="text-uppercase">{{ Auth::user()->username }}</span>!
                    </h2>
                </div>
            ...
            <div class="modal-body text-center">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <form action="{{ route('profil.destroy') }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-confirm-action btn-confirm-yes">YA</button>
                    </form>
                    
                    <button type="button" class="btn btn-confirm-action btn-confirm-no"
